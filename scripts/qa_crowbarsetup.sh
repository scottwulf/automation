...
function onadmin_prepareinstallcrowbar
{
    ...
    [[ -e /root/cloud-keys/crowbarsecrets.sh ]] && . /root/cloud-keys/crowbarsecrets.sh
    onadmin_repocleanup
...
EOF
    ...
    if [[ $cloud = p2 ]] ; then
        ...
        /opt/dell/bin/json-edit -a attributes.network.networks.public.ranges.host.start -v 10.84.199.253 $netfile
        ...
        /opt/dell/bin/json-edit -a attributes.network.networks.nova_floating.ranges.host.start -v 10.84.200.1 $netfile
...
function oncontroller_setupproduction()
{
    ...
    nova flavor-create --ephemeral 80 d8.smaller 24 1024 80 2
